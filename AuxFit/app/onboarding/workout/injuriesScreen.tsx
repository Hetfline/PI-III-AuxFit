...
const INJURY_OPTIONS: OptionItem[] = [
  ...
  { id: 'joelho', label: 'Joelho', icon: 'human-male' }, // Ícone genérico que remete a perna/corpo
  ...
  { id: 'nenhuma', label: 'Nenhuma (100% Saudável)', icon: 'check-circle-outline', color: Colors.correct },
];
...
export default function InjuriesScreen() {
  ...
  const handleNext = () => {
    ...
    // Próxima tela: Foco Muscular (a última pergunta antes do resumo)
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        {/* Pergunta 6 de 7 */}
        <ProgressBar currentQuestion={6} totalQuestions={7} onBack={() => router.replace("/onboarding/workout/experienceScreen")} />

        <View style={styles.content}>
          <View style={styles.topSection}>
            <Text style={styles.question}>Você possui alguma dor, lesão ou limitação?</Text>
            <Text style={styles.subtitle}>Isso é muito importante para evitarmos exercícios perigosos para você.</Text>
          </View>
