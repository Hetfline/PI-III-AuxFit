  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        {/* Pergunta 4 de 7 */}
        <ProgressBar currentQuestion={4} totalQuestions={7} onBack={() => router.replace("/onboarding/workout/experienceScreen")} />

        <View style={styles.content}>
          <View style={styles.topSection}>
            <Text style={styles.question}>Quais equipamentos você tem acesso?</Text>
            <Text style={styles.subtitle}>Isso ajuda a filtrar os exercícios que você pode fazer.</Text>
          </View>
          ...
          <ScrollView style={{marginTop: 20}} contentContainerStyle={{paddingBottom: 20}}>
            <SelectionList 
                ...
                variant="tag"       // Estilo TAG (melhor para multiplas opções curtas)
