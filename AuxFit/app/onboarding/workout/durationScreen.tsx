...
const DURATION_OPTIONS: OptionItem[] = [
  {
    id: '20_min',
    label: '20 minutos',
    description: 'Treino express. Foco total em intensidade e poucos descansos.',
    icon: 'timer-sand',
    color: '#4CAF50'
  },
  {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <Background />
        <Toast message="Selecione a duração ideal." visible={showToast} onHide={() => setShowToast(false)} type="warning" />
        
        {/* Pergunta 3 de 7 */}
        <ProgressBar currentQuestion={3} totalQuestions={7} onBack={() => router.back()} />

        <View style={styles.content}>
          <View style={styles.topSection}>
            <Text style={styles.question}>Quanto tempo você tem disponível por treino?</Text>
            <Text style={styles.subtitle}>Isso define o volume (quantidade de séries e exercícios) do seu dia.</Text>
          </View>
