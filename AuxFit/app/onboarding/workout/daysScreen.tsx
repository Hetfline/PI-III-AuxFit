...
const DAYS_OPTIONS: OptionItem[] = [
  {
    ...
    description:
      "Ideal para Full Body (Corpo todo). Ótimo para quem tem pouco tempo.",
  ...
  },
  {
    ...
    description:
      "Divisão AB (Upper/Lower). Equilíbrio perfeito entre treino e descanso.",
    icon: "calendar-month",
    color: "#2196F3",
  },
  {
    ...
    description:
      "Divisão ABC ou Upper/Lower híbrido. Para quem gosta de ir quase todo dia.",
    icon: "calendar-check",
    color: "#FFC107",
  },
  {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <Background />
        <Toast
          message="Selecione quantos dias quer treinar."
          visible={showToast}
        ...
        <View style={styles.content}>
          <View style={styles.topSection}>
            ...
            <Text style={styles.subtitle}>
              Isso define a divisão do seu treino (Ex: Full Body, ABC, etc).
            </Text>
          </View>
